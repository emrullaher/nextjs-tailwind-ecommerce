					...
					<div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
						<div>
							<svg
								...
								className="fill-teal-700 dark:fill-white"
							>
								<path
							...
							<h1 className="mt-4 text-xl font-semibold text-teal-700 dark:text-white">
						...
						<div>
							...
							<h1 className="mt-4 text-xl font-semibold text-teal-700 dark:text-white">Express Shipping</h1>
