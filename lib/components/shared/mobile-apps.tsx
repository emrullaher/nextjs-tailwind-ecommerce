...
export const MobileApps = () => {
	return (
		<>
			<section className="bg-gray-800 py-10 dark:bg-gray-900">
				<div className="container mx-auto flex flex-col items-center px-4 py-12 text-center">
					<h2 className="text-2xl font-bold capitalize tracking-tight text-white xl:text-3xl">
					...
					<div className="mt-6">
						<Link
							className="inline-flex w-full items-center justify-center overflow-hidden rounded-lg bg-teal-700 px-4 py-2.5 text-sm text-white shadow transition-colors duration-300 hover:bg-teal-900 focus:ring focus:ring-gray-300 focus:ring-opacity-80 dark:bg-gray-800 dark:hover:bg-gray-700 sm:mx-2 sm:w-auto"
